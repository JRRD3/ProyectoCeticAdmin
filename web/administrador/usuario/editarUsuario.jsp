...
//    System.out.println("editarUsuario: "+min);
    String Id = request.getParameter("user");
//    String upp = "", nombreDepto = "", Nombre = "",aPaterno = "", aMaterno = "", Usr = "", Pssw = "", Rol = "", FechaNac = "", email = "", tipo = "", idRol = "";
...
<html>
    ...
    <body style="padding-top: 0px;">
        ...
        <!--<script src="/ceticAdmin/assets/scripts/jquery-1.10.1.min.js"></script>-->
...
//                    alert(urlAc);
                    if(est === undefined)
                        window.top.location.href = urlAc+"?NBVF="+encEstatus+"&TUOG="+encLogout;
                    else
                        window.top.location.href = window.top.location.href.substring(0,window.top.location.href.lastIndexOf("jsp")+3)+"?NBVF="+encEstatus+"&TUOG="+encLogout;
