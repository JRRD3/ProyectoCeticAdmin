...
(function (c) {
    ...
    j = function (a, b) {
        ...
        }, j.defaults, n.defaults.responsive, b), a.responsive = this, this._constructor())
    };
    c.extend(j.prototype, {
        ...
        _columnsVisiblity: function (a) {
            ...
            h = !1;
            e = 0;
            for (f = d.length; e < f; e++) if (!d[e].control &&
            !d[e].never && !g[e]) {
                h = !0;
                break
            }
        ...
        _classLogic: function () {
            ...
            e = d.columns().eq(0).map(function (a) {
                ...
                a === p && (a = c(b.header).data('priority') !== p ? 1 * c(b.header).data('priority')  : 10000);
                return {
                    className: e,
                    includeIn: [
                    ],
        ...
        _detailsDisplay: function (a, b) {
            ...
            (!0 === f || !1 === f) && c(e.table().node()).triggerHandler('responsive-display.dt', [
                e,
                a,
                f,
                b
    ...
    j.display = {
        childRow: function (a, b, d) {
            if (b) {
                if (c(a.node()).hasClass('parent')) return a.child(d(), 'child').show(),
                !0
            } else {
        ...
        childRowImmediate: function (a, b, d) {
            if (!b && a.child.isShown() || !a.responsive.hasHidden()) return a.child(!1),
            c(a.node()).removeClass('parent'),
            !1;
            a.child(d(), 'child').show();
            c(a.node()).addClass('parent');
