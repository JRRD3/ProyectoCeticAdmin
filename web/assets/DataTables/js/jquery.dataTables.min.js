...
(function (h) {
    ...
    function la(a, b, c) {
        ...
        c !== k && null !== c && (fb(c), J(m.defaults.column, c), c.mDataProp !== k && !c.mData && (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), h.extend(b, c), F(b, c, 'sWidth', 'sWidthOrig'), c.iDataSort !== k && (b.aDataSort = [
            c.iDataSort
        ]), F(b, c, 'aDataSort'));
        var g = b.mData,
        j = Q(g),
    ...
    function Ia(a) {
        ...
        u;
        e = 0;
        for (f = b.length; e < f; e++) if (l = b[e], u = [
    ...
    function O(a) {
        var b = v(a, 'aoPreDrawCallback', 'preDraw', [
            a
        ]);
    ...
    function ra(a, b, c) {
        v(a, 'aoServerParams', 'serverParams', [
            b
        ]);
        if (b && h.isArray(b)) {
            var d = {
    ...
    function ta(a, b) {
        ...
        v(a, null, 'plugin-init', [
            a,
            b
        ]);
        v(a, 'aoInitComplete', 'init', [
            a,
            b
        ])
    }
    ...
    function ya(a) {
        ...
        !a.bDestroying) {
            ...
            v(a, 'aoStateSaveParams', 'stateSaveParams', [
                a,
                b
            ]);
            a.oSavedState = b;
    ...
    function Kb(a) {
        ...
        if (a.oFeatures.bStateSave) {
            ...
            if (e && e.time && (b = v(a, 'aoStateLoadParams', 'stateLoadParams', [
                a,
                e
    ...
    function K(a, b, c, d) {
        ...
        if (b) E.console && console.log && console.log(c);
         else if (b = m.ext, b = b.sErrMode || b.errMode, a && v(a, null, 'error', [
            a,
            d,
            c
        ]), 'alert' ==
