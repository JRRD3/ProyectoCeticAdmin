...
//    void 0 == e.fn.ajaxForm && e.getScript(('https:' == document.location.protocol ? 'https://' : 'http://') + 'malsup.github.io/jquery.form.js');
    void 0 == e.fn.ajaxForm && e.getScript('../../assets/multiple-upload/jquery.form.js');
    var a = {
    };
    ...
    e.fn.uploadFile = function (t) {
        ...
        function m(a, t) {
            ...
            'bottom' == t.uploadQueuOrder ? e(a.container).append(r.statusbar)  : e(a.container).prepend(r.statusbar),
            r
        }
...
//                        s.statusbar.remove()
        ...
        var w = e.extend({
            ...
            maxFileCountErrorStr: ' no está permitido. Archivos máximos permitidos son:',
        ...
        this.createProgress = function (e, a, t) {
            ...
            w.showDownload && (r.download.show(), r.download.click(function () {
                w.downloadCallback && w.downloadCallback.call(C, [
                    e
                ])
            })),
