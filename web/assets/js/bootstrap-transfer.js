(function($) {
    $.fn.bootstrapTransfer = function(options) {
        ...
        this.initialize_target = function(values) {
            _this.initialize_target(values);
        };
        ...
        return this.each(function() {
            ...
            _this.update_lists = function(force_hilite_off) {
                ...
                _this.$remaining_select.find('option').each(function() {
                    var inner = "";
                    if (_this.$filter_input.val() !== undefined) {
                ...
                <tr>\
                    <td width="50%">\
                        <div class="selector-available">\
                            ...
                            <select multiple="multiple" class="filtered remaining" name="listaPendientes">\
                            </select>\
                    ...
                    <td width="50%">\
                        <div class="selector-chosen">\
                            ...
                            <select multiple="multiple" class="filtered target" name="listaAsignados">\
                            </select>\
 ...
 * <div class="selector-filter">\
 ...
 <p>Seleccionar y click</p><span class="illustration"></span>\
 </div>\
 */